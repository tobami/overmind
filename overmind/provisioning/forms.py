...
class ProviderForm(ModelForm):
    def __init__(self, provider_type, *args, **kwargs):
        ...
        self.fields['access_key'].label = PROVIDERS[provider_type]['access_key']
        self.fields['secret_key'].label = PROVIDERS[provider_type]['secret_key']
        if PROVIDERS[provider_type]['secret_key'] is None:
